define(['jQuery', 'Underscore', 'Backbone', 'Observer', 'clipboard.content-tmpl', 'niceDate'], function ($, _, Backbone, Observer, tmpl, niceDate) {
	...
	var Model = Backbone.Model.extend(),
		...
		View = Backbone.View.extend({
			...
			initialize : function () {
				...
				Observer.bind('itemAdded', function () {
					this.collection.fetch();
				}, this);
			},
			...
			saveChanges  : function (evnt) {
				...
				this.updateNote({
					type : 'text',
					_id : _id,
					text : escape(text.replace(/</g, '&lt;').replace(/>/g, '&gt;'))
				});
